...
def main(start_time, file):
    ...
    ax2 = plt.subplot(222)
    ax2.set_title('Tone Window')
    ax2.set_xlabel('Time')
    ax2.set_ylabel('Amplitude')    
    ax2.plot(time_slice, sample_slice)
    ...
    ax3 = plt.subplot(212)
    ax3.set_title('Tone Window FFT')
    ax3.set_xlabel('Frequency')
    ax3.set_ylabel('Amplitude')
    #absolute because we only care about the positive amplitude
    ax3.plot(frq, abs(sample_slice_fft))
